...
{
    public class MartenRoleStore : IRoleStore<ApplicationRole>
    {
        ...
        public Task<ApplicationRole?> FindByNameAsync(string normalizedRoleName, CancellationToken cancellationToken)
        {
            ...
            var role = roles.FirstOrDefault(c => c.ToUpperInvariant() == normalizedRoleName);
            if (role == null)
                throw new NotFoundException("Role not found");

            return Task.FromResult<ApplicationRole?>(new ApplicationRole(role));
        }
