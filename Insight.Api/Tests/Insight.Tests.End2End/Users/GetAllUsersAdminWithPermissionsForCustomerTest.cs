...
{
    [Collection("End2End")]
    public class GetAllUsersAdminWithPermissionsForCustomerTest
    {
        private readonly Api api;
        private readonly WebAppFixture webAppFixture;
        private readonly Fixture any = new();

        public GetAllUsersAdminWithPermissionsForCustomerTest(WebAppFixture webAppFixture)
        {
        ...
        [Fact]
        public async Task GetAllUsersAdmin_WithPermissionsForCustomer_ShouldReturnUsersForThatCustomer()
        {
            //Arrange
            ...
            //Act
            var users = await api.GetAllUsersAdmin(1,10, true, "id", "Active", "", "");
        ...
        [Fact]
        public async Task GetAllUsersAdmin_WithPermissionsForOneCustomer_ShouldNotReturnUsersForOtherCustomers()
        {
            //Arrange
            var customerId = Guid.NewGuid();
         ...
         [Fact]
        public async Task GetAllUsersAdmin_Filtering_Email()
        {
            //Arrange
            var customerId = Guid.NewGuid();
            var otherCustomerId = Guid.NewGuid();
            ...
            //Act
            var users = await api.GetAllUsersAdmin(1, 10, true, "id", "Active", "", userName);
