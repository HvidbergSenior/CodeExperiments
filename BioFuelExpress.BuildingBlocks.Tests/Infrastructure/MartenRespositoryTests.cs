...
namespace BioFuelExpress.BuildingBlocks.Tests.Infrastructure
{
    ...
    public class MartenRespositoryTests : IAsyncLifetime
    {
        ...
        //{
        //var something = new PostgreSqlBuilder().Build();
        //    await something.StartAsync();
        ...
        //    options.Connection(something.GetConnectionString());
